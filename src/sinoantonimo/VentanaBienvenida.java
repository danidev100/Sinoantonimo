...
public class VentanaBienvenida extends javax.swing.JFrame {
    ...
    private void initComponents() {
    	...
    	/**
    	 * InicializaciÛn de instancias sobre la ventana principal
    	 */
        ...
        /**
         * DefiniciÛn y parametrizaciÛn para labels y buttons
         */
        jLabel1.setFont(new java.awt.Font("Tempus Sans ITC", 1, 14)); // NOI18N
        jLabel1.setText("Prueba tu conocimiento con este reto de sin√≥nimos y ant√≥nimos");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("Nombre del jugador:");

        TextNombreJugador.setText("Ingrese aqu√≠ su nombre");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      this.setVisible(false);  //en estas dos lineas de codigo  (98 y 99) le estamos dciendo al c√≥digo que la ventana actual se oculte para dar paso a la siguiente
